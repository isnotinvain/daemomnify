...
inline const char* NAMES[NUM_QUALITIES] = {"Major", "Minor", "Dominant 7th", "Major 7th", "Minor 7th", "Diminished 7th", "Augmented", "Suspended 4th", "Add 9"};
...
struct NotePerChordQuality {
    static constexpr const char* TYPE = "NotePerChordQuality";
    std::map<int, ChordQuality> note_mapping;
};

struct CCPerChordQuality {
    static constexpr const char* TYPE = "CCPerChordQuality";
    std::map<int, ChordQuality> cc_mapping;
};
...
using ChordVoicingStyle = std::variant<RootPositionStyle, FileStyle, Omni84Style>;
using StrumVoicingStyle = std::variant<PlainAscendingStrumStyle, OmnichordStrumStyle>;
using ChordQualitySelectionStyle = std::variant<NotePerChordQuality, CCPerChordQuality, CCRangePerChordQuality>;
